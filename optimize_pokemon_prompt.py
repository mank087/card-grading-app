#!/usr/bin/env python3
"""
Pokemon Prompt Optimization
Apply same optimizations as sports prompt:
- Condense inspection protocols
- Streamline scoring tables
- Remove redundancy
- Maintain Pokemon-specific context
"""

import re
from pathlib import Path

def optimize_pokemon(input_file, output_file):
    ...
    # Stage 6: Streamline grade calculation
...
(Apply CREASE DETECTION MASTER PROTOCOL for any suspect lines)
"""
...
def compact_scoring_tables(content):
    """Simplify the component scoring tables"""
...
def final_cleanup(content):
    ...
    # Remove redundant "See X protocol" references
...
if __name__ == "__main__":
    ...
    optimize_pokemon(input_file, output_file)
