...
import { YugiohCardDetailsV2 } from './CardDetailV2Client';
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  // Non-UUID ids (e.g. /yugioh/null from bots or stale links) would fail in Postgres with 22P02
...
export default async function YugiohCardDetailPage({ params, searchParams }: PageProps) {
  const { id } = await params;
  ...
  return version === 2 ? <YugiohCardDetailsV2 /> : <YugiohCardDetails />;
}
