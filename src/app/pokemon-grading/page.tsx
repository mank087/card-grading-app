              ...
              {isLoading ? (
                ...
                <div className="bg-gray-800/80 backdrop-blur-xl rounded-2xl border border-gray-700 overflow-hidden">
                  ...
                  <div className="p-6">
                    ...
                    {/* Pricing teaser */}
                    <div className="bg-gradient-to-r from-purple-500/10 to-indigo-500/10 border border-purple-500/30 rounded-lg p-3 mb-5 text-center">
            ...
            <div className="w-full max-w-md">
              <div className="bg-gray-800/80 backdrop-blur-xl rounded-2xl border border-gray-700 overflow-hidden shadow-2xl">
                ...
                <div className="p-6">
                  ...
                  {/* Pricing teaser */}
                  <div className="bg-gradient-to-r from-purple-500/10 to-indigo-500/10 border border-purple-500/30 rounded-lg p-4 mb-6 text-center">
                    <p className="text-purple-300 text-sm">
                      Plans starting at <span className="text-white font-bold text-lg">$0.66</span> per card
                    </p>
                  </div>
