...
function CollectionPageContent() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-4 sm:p-8">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-8">
          <div>
            <div className="flex items-center gap-3">
              ...
              {isVip && (
                <span className="inline-flex items-center gap-1 bg-gradient-to-r from-indigo-500 to-purple-600 text-white text-sm font-semibold px-3 py-1 rounded-full shadow">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M10 2L13 8L20 9L15 14L16.5 21L10 17.5L3.5 21L5 14L0 9L7 8L10 2Z" />
                  </svg>
                  VIP
                </span>
              )}
              {isCardLover && (
                <span className="inline-flex items-center gap-1 bg-gradient-to-r from-rose-500 to-pink-500 text-white text-sm font-semibold px-3 py-1 rounded-full shadow">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
      ...
      {sellCard && (
        <MarkAsSoldDialog
          cardName={getPlayerName(sellCard)}
          serial={sellCard.serial}
