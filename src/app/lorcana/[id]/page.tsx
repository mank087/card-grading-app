...
import { LorcanaCardDetailsV2 } from './CardDetailV2Client';
...
export default async function LorcanaCardDetailPage({ params, searchParams }: PageProps) {
  const { id } = await params;
  ...
  return version === 2 ? <LorcanaCardDetailsV2 /> : <LorcanaCardDetails />;
}
