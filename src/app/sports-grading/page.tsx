        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-emerald-900/50 to-teal-900/50 rounded-2xl p-6 border border-emerald-700/30 text-center">
              ...
              <p className="text-gray-400 text-sm">Get your grade in about a minute — no waiting weeks for a slab</p>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Your DCM grade, translated into estimated PSA, BGS, SGC, and CGC terms</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="bg-gray-800/40 backdrop-blur-sm rounded-2xl border border-gray-700/50 p-6 text-center mb-6">
            <p className="text-gray-300">
              ...
              grade-adjusted pricing on every card you grade, so a raw rookie and a graded one stop being the same number to you.
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-emerald-900 to-teal-900">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Stop wondering what your cards are worth. Grade the box, get a real grade and a real label on every card.{' '}
            Most of your collection ends here. The top slice still goes out — we&apos;ll{' '}
            <Link href="/psa-alternative" className="text-emerald-400 hover:text-emerald-300 underline">tell you which</Link>.
          </p>
          {user ? (
            <Link
              href="/credits"
