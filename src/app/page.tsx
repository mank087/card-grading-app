    ...
    <section className="py-16 bg-gradient-to-br from-purple-50 to-blue-50">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h2 className="text-3xl font-bold text-gray-900">Real Cards, Real Grades</h2>
            <p className="text-gray-600 mt-2">Recently graded by collectors like you. Tap any card to see its full report.</p>
            <Link
              href="/featured"
