          ...
          <div className="max-w-2xl mx-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Grading Question">Grading Question</option>
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-bold py-4 px-6 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
            ...
            <div className="relative my-10">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-gray-500">or reach us directly</span>
              </div>
            </div>
            ...
            <div className="mb-10">
              ...
              <div className="flex items-center justify-center space-x-8">
                {/* Facebook */}
                <a
                  href="https://www.facebook.com/dcmgrading"
                  target="_blank"
                ...
                {/* Instagram */}
                <a
                  href="https://www.instagram.com/dcm_grading/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center space-y-2 text-gray-600 hover:text-pink-600 transition-colors group"
                  aria-label="Instagram"
                >
                  <div className="w-14 h-14 bg-gray-100 group-hover:bg-pink-50 rounded-full flex items-center justify-center transition-colors">
                    <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
