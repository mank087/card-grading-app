              ...
              {(() => {
                ...
                return (
                  <div id="tour-download-buttons" className="flex flex-col md:flex-row items-center justify-between gap-4 my-6 px-4">
                    ...
                    {isOwner && <DownloadReportButton card={card} cardType="onepiece" showFounderEmblem={showFounderEmblem} showCardLoversEmblem={showCardLoversEmblem} labelStyle={labelStyle} />}
              ...
              <div id="tour-live-market-pricing" className="bg-white rounded-lg shadow-lg p-6">
                <EbayPriceLookup
                  card={{
                    ...
                    card_number: cardInfo.card_id || cardInfo.collector_number || card.card_number,
                    release_date: cardInfo.set_year || card.release_date,
                    rarity_or_variant: cardInfo.rarity || cardInfo.op_variant_type,
                    variant_type: cardInfo.variant_type || card.op_variant_type,
                    is_foil: card.is_foil || cardInfo.is_foil || false,
                ...
                return (
                  <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      List this card directly on eBay with your DCM grade and professional images.
                    </p>
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-4 mb-4">
                      ...
                      <ul className="text-sm text-gray-600 space-y-1">
                        <li className="flex items-center gap-2">
                          ...
                          Professional card images (front & back)
                        </li>
                        <li className="flex items-center gap-2">
                          <span className="text-green-500">✓</span>
                          DCM grade label image
                        </li>
                        <li className="flex items-center gap-2">
                          <span className="text-green-500">✓</span>
                          Mini grading report image
                        </li>
                        <li className="flex items-center gap-2">
                          <span className="text-green-500">✓</span>
                          Pre-filled One Piece TCG item specifics
                        </li>
                        <li className="flex items-center gap-2">
                          <span className="text-green-500">✓</span>
                          Set name, card number, and rarity
                        </li>
                      </ul>
                    </div>
