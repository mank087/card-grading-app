...
import { OtherCardDetailsV2 } from './CardDetailV2Client';
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  // Non-UUID ids (e.g. /other/null from bots or stale links) would fail in Postgres with 22P02
...
export default async function OtherCardDetailPage({ params, searchParams }: PageProps) {
  const { id } = await params;
  ...
  return version === 2 ? <OtherCardDetailsV2 /> : <OtherCardDetails />;
}
