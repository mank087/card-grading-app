      ...
      <main className="max-w-4xl mx-auto px-4 py-12 relative z-10">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li className="flex items-start gap-2">
                  ...
                  Card fills the frame, with minimal background
                </li>
                <li className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              ...
              <ul className="text-sm text-gray-700 space-y-1">
                ...
                <li>• Handwritten additions that are not signatures</li>
              </ul>
        ...
        <section className="bg-gray-100 rounded-2xl p-8">
          ...
          <p className="text-gray-700 text-sm mb-4">
            ...
            generated by DCM Optic™, our proprietary grading engine, from submitted photographs. Our grades are based on
