...
// `aliasId` renders a second, stable anchor inside a section so an outside
// link can name what the reader is looking for rather than the internal id.
// `#labels` -> the Avery label stock in "03 / Printing & trimming"; the card
// detail page's holder cards link to it (lib/cardDetail/holderSupport.ts).
const sections = [
