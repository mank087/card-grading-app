        ...
        <div className="container mx-auto px-4 py-3 md:py-4">
          ...
          <div className={`md:hidden overflow-hidden transition-all duration-300 ${showMobileFilters ? 'max-h-96 mt-3' : 'max-h-0'}`}>
            <div className="grid grid-cols-2 gap-2">
              <div>
                <label htmlFor="database-filter-1" className="block text-xs text-gray-400 mb-1">Card ID</label>
              ...
              <div>
                <label htmlFor="database-filter-3" className="block text-xs text-gray-400 mb-1">Color</label>
              ...
              <div>
                <label htmlFor="database-filter-4" className="block text-xs text-gray-400 mb-1">Type</label>
          ...
          <div className="hidden md:flex md:flex-row gap-3">
            ...
            {/* Card ID Search */}
            <div className="w-40">
              <label htmlFor="database-filter-6" className="block text-xs text-gray-400 mb-1">Card ID</label>
            ...
            {/* Color Filter */}
            <div className="w-36">
              <label htmlFor="database-filter-8" className="block text-xs text-gray-400 mb-1">Color</label>
            ...
            {/* Type Filter */}
            <div className="w-36">
              <label htmlFor="database-filter-9" className="block text-xs text-gray-400 mb-1">Type</label>
        ...
        {selectedCard && (
          <div className="p-6">
            ...
            <Link
              ...
              className="block w-full dcm-directory-accent text-white font-bold text-lg px-6 py-4 rounded-xl hover:from-red-500 hover:to-orange-400 transition-all text-center shadow-lg shadow-red-500/20 mb-4"
            >
              {getGradeCtaText()}
            </Link>
      ...
      <div className="py-8 bg-gray-900 border-t border-gray-800">
        <div className="container mx-auto px-4 text-center text-gray-500 text-sm">
          ...
          <div className="flex justify-center gap-6 mt-4">
            <Link href="/upload?category=One%20Piece" className="hover:text-gray-300 transition-colors">Grade Cards</Link>
