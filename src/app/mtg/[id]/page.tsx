...
import { MTGCardDetailsV2 } from './CardDetailV2Client';
...
export default async function MTGCardDetailPage({ params, searchParams }: PageProps) {
  const { id } = await params;
  ...
  return version === 2 ? <MTGCardDetailsV2 /> : <MTGCardDetails />;
}
