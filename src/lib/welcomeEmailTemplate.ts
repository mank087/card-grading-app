 ...
 *
 * Lifted out of /api/email/welcome/route.ts so both the legacy endpoint and
 * the new auth-user-created webhook can render the same content via the
 * sendWelcomeEmail helper.
 *
 * Email-safe HTML: table-based layout, inline styles, no CSS gradients,
    ...
    <tr>
      <td align="center" style="padding: 20px 10px 40px 10px;">
        ...
        <table role="presentation" class="email-container" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width: 600px; width: 100%; background-color: #ffffff; margin: 0 auto;">
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td width="130" style="padding: 12px 0 12px 20px;" valign="middle">
                    <a href="https://dcmgrading.com/?utm_source=email&utm_medium=email&utm_campaign=welcome&utm_content=nav-logo" style="text-decoration: none;">
          ...
          <!-- MOBILE APP CALLOUT -->
          <tr>
            <td style="padding: 28px 30px 28px 30px; background-color: #f9fafb;">
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td align="center">
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" class="badge-stack" style="margin: 0 auto 10px auto;">
                      <tr>
                        <td align="center" valign="middle" style="padding: 0 6px;">
                          <a href="https://apps.apple.com/us/app/dcm-grading/id6768663163?utm_source=email&utm_medium=email&utm_campaign=welcome&utm_content=mobile-badge-apple" style="text-decoration: none;"><img src="https://dcmgrading.com/app-store-badge/Download_on_the_App_Store_Badge_US-UK_RGB_blk.png" alt="Download on the App Store" width="160" height="54" style="display: block; width: 160px; height: 54px;"></a>
                        </td>
                        <td align="center" valign="middle" style="padding: 0 6px;">
                          <a href="https://play.google.com/store/apps/details?id=com.dcmgrading.app&utm_source=email&utm_medium=email&utm_campaign=welcome&utm_content=mobile-badge-google" style="text-decoration: none;"><img src="https://dcmgrading.com/app-store-badge/GetItOnGooglePlay_Badge_Web_color_English.png" alt="Get it on Google Play" width="160" height="48" style="display: block; width: 160px; height: 48px;"></a>
                        </td>
                      </tr>
                    </table>
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: 0 auto;">
                      <tr>
                        <td bgcolor="#065f46" style="padding: 0; border-radius: 8px;">
                          <a href="https://dcmgrading.com/credits?utm_source=email&utm_medium=email&utm_campaign=welcome&utm_content=promo-code-button" style="display: inline-block; color: #ffffff; font-size: 24px; font-weight: 800; letter-spacing: 3px; font-family: 'Courier New', Courier, monospace; text-decoration: none; padding: 12px 28px;">Grade10</a>
                        </td>
                      </tr>
                    </table>
          ...
          <tr>
            <td class="pad-mobile-sm" style="padding: 10px 30px 25px 30px;">
              ...
              <a href="https://dcmgrading.com/credits?utm_source=email&utm_medium=email&utm_campaign=welcome&utm_content=pricing-table" style="text-decoration: none;">
