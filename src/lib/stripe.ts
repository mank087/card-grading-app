...
// Loyalty bonus milestones for monthly subscribers — canonical table lives
// in subscriptionConstants.ts (shared with credits.ts); re-exported here so
// existing `from '@/lib/stripe'` imports keep working.
export { CARD_LOVERS_LOYALTY_BONUSES } from './subscriptionConstants';
