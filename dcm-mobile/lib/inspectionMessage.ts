 ...
 *
 * The wording matches the web's src/lib/grading/inspectionMessage.ts word for
 * word; keep the two in step. The refund line only claims what the server
 * confirmed: a refund is mentioned only when `credit_refunded` is true.
 */
