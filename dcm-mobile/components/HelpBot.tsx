...
const KB: KBEntry[] = [
  ...
  { id: '4', q: 'How much does grading cost?', a: Platform.OS === 'ios'
      ...
      : 'Basic: $2.99/1 card, Pro: $9.99/5 cards, Elite: $19.99/20 cards, VIP: $99/150 cards. Founders and Card Lovers get 20% off.',
    keywords: ['cost', 'price', 'credits', 'how much'], cat: 'pricing' },
  ...
  { id: '14', q: 'What is Card Lovers?', a: Platform.OS === 'ios'
