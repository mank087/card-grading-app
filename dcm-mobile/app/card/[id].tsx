...
export default function CardDetailScreen() {
  ...
  const TOUR_STEPS: TourStep[] = [
    ...
    { id: 'visibility-toggle', title: 'Privacy & Label Style', description: 'Control who can see your card with the Public/Private toggle. Switch the slab label between Heritage, Modern and Traditional, or any custom design you saved in Label Studio.' },
    ...
    { id: 'download-buttons', title: 'Download Reports & Labels', description: 'Download the full grading report or a mini-report as a PDF, print labels for graded slabs, magnetic one-touch holders and toploaders, or save the card images with their grade labels. Your DCM serial number and share links live here too.' },
    ...
    { id: 'market-value', title: 'Market Value', description: 'Your estimated value at this grade, based on real sold listings, plus quick links to search eBay, TCGplayer and other marketplaces. Prices refresh every Sunday, and Card Lovers can refresh on demand.', sectionId: 'market-value' },
