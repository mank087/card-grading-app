 ...
 *
 * Routed in from credits.tsx (Platform.OS === 'ios' branch). The
 * underscore prefix on this filename keeps it private from expo-router
 * so it never resolves as its own /pages/_credits_ios URL.
 *
 * Android does NOT load this file. It uses dcmgrading.com/credits in an
 * InAppPage WebView — Google approved Stripe-in-WebView for Android,
 * which Apple does not allow. Mirrors the same pattern used by
 * pages/vip.tsx and pages/card-lovers.tsx for the same compliance reason.
 *
