...
const subject = "Professional card grading, made simple";
                ...
                <tr>
                  <td align="center">
                    ...
                    <p style="color: #9ca3af; font-size: 11px; margin: 0; font-family: Arial, Helvetica, sans-serif;">
                      <a href="${testUnsubscribeUrl}" style="color: #9ca3af; text-decoration: underline;">Unsubscribe</a> from marketing emails
                    </p>
                  </td>
                </tr>
              </table>
...
async function sendTestEmail() {
  const targetEmail = process.argv[2] || 'admin@dcmgrading.com';
